...
export default function WorkspaceClientTimeTracking() {
  ...
  const photoUrl = selectedCollab?.candidate?.candidate?.photo_url;
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-end mb-6">
          ...
          <div className="w-full md:w-auto min-w-[260px]">
            ...
            <div className="relative">
              {photoUrl ? (
                <img src={photoUrl} alt="Avatar" className="absolute left-3 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full object-cover pointer-events-none z-10" />
              ) : (
                <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center z-10">
              ...
              <select
                ...
                className="w-full appearance-none bg-slate-50 border border-slate-200 text-slate-900 px-4 py-3 pl-12 pr-10 rounded-xl text-sm font-bold focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition-all"
              >
