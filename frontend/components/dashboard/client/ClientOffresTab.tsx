...
import {
  PlusCircle, Briefcase, Users, Trash2,
  ChevronLeft, ChevronRight as ChevronRightIcon, ChevronDown, ChevronUp
} from 'lucide-react';
import Modal from '@/components/ui/Modal';
import clsx from 'clsx';
import { jobOfferApi } from '@/lib/job-offer-service';
import { skillApi, Skill } from '@/lib/skill-service';
import ClientOfferFormModal from './ClientOfferFormModal';
